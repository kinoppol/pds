...
$timeline_data=sSelectTb($systemDb,'investigate_timeline','*','investigate_id='.sQ($hGET['id']).' AND step_id='.sQ($hGET['step_id']));
...
$saveURL=site_url('ajax/investigate/progress/save/id/'.$hGET['id'].'/step_id/'.$hGET['step_id']);
